...
This documentation describes how to use the Login.gov Design System in a new project. Read [CONTRIBUTING.md](https://gitlab.login.gov/lg/identity-design-system/-/blob/main/CONTRIBUTING.md) to learn more about contributing to the design system itself.
...
See [LICENSE](https://gitlab.login.gov/lg/identity-design-system/-/blob/main/LICENSE) for licensing information.
