...
- Upgrade USWDS from v3.8.1 to v3.8.2 (see [release notes](https://github.com/uswds/uswds/releases/tag/v3.8.2)) ([!14](https://gitlab.login.gov/lg/identity-design-system/-/merge_requests/14))
